...
from network_base_zq_2x2 import max_pool, upsample, inverted_bottleneck, separable_conv, convb, dwconvb, is_trainable, base_block_2x2, overall_block_2x2
...
def build_network(input, trainable):
    ...
    if not use_2x2:
        ...
        net = convb(input, 2, 2, 16, 2, name="Conv2d_0_0")
        net = overall_block_2x2('CONV', net, num_filters=16, num_blocks=(5*5-4)//8-1, name="Conv2d_0_2", stride=None)
    ...
    with tf.variable_scope('MV'):
        ...
        if not use_2x2:
            ...
            mv2_branch_0 = overall_block_2x2('SEPARABLE', net, num_filters=16, num_blocks=3, name="Conv2d_1_dw", stride=None)
        ...
        if not use_2x2:
            ...
            mv2_branch_1 = dwconvb(mv2_branch_0, 2, 2, 2, name="Conv2d_2_dw")
            mv2_branch_1 = overall_block_2x2('SEPARABLE', mv2_branch_1, num_filters=24, num_blocks=(5*5-4)//8-1, name="Conv2d_2_oa", stride=None)
        ...
        if not use_2x2:
            ...
            mv2_branch_2 = dwconvb(mv2_branch_1, 2, 2, 2, name="Conv2d_3_dw")
            mv2_branch_2 = overall_block_2x2('SEPARABLE', mv2_branch_2, num_filters=32, num_blocks=(5*5-4)//8-1, name="Conv2d_3_dw", stride=None)
        ...
        if not use_2x2:
            ...
            mv2_branch_3 = dwconvb(mv2_branch_2, 2, 2, 2, name="Conv2d_4_dw")
            mv2_branch_3 = overall_block_2x2('SEPARABLE', mv2_branch_3, num_filters=32, num_blocks=(7*7-4)//8-1, name="Conv2d_4_oa", stride=None)
        ...
        if not use_2x2:
            ...
            mv2_branch_4 = dwconvb(mv2_branch_3, 2, 2, 2, name="Conv2d_5_dw")
            mv2_branch_4 = overall_block_2x2('SEPARABLE', mv2_branch_4, num_filters=32, num_blocks=(7*7-4)//8-1, name="Conv2d_5_oa", stride=None)
