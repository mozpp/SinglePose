...
from mobilenet import conv_blocks_with_2x2 as ops
...
V3_SMALL_MINIMALISTIC_2x2 = dict(
    defaults=dict(DEFAULTS),
    spec=([
        # stage 1
        # op(slim.conv2d, stride=2, num_outputs=16, kernel_size=(3, 3)),
        op(slim.conv2d, stride=2, num_outputs=16, kernel_size=(2, 2), padding="VALID"),

        mbv3_op(ef=1, n=16, k=2, s=2, padding="VALID"),
        mbv3_op(ef=72. / 16, n=24, k=2, s=2, padding="VALID"),
        mbv3_op(ef=(88. / 24), n=24, k=2, s=1, padding="VALID"),
        mbv3_op(ef=4, n=40, k=2, s=2, padding="VALID"),
        mbv3_op(ef=6, n=40, k=2, s=1, padding="VALID"),
        mbv3_op(ef=6, n=40, k=2, s=1, padding="VALID"),
        mbv3_op(ef=3, n=48, k=2, s=1, padding="VALID"),
        mbv3_op(ef=3, n=48, k=2, s=1, padding="VALID"),
        mbv3_op(ef=6, n=96, k=2, s=2, padding="VALID"),
        mbv3_op(ef=6, n=96, k=2, s=1, padding="VALID"),
        mbv3_op(ef=6, n=96, k=2, s=1, padding="VALID"),
    ]))
