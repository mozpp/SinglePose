...
def get_input(batchsize, epoch, is_train=True):
    ...
    input_pipeline = input_pipeline.repeat()
...
def main(argv=None):
    ...
    config_file = "../experiments/zq21_cpm.cfg"
    if len(argv) != 1:
        config_file = argv[1]
    ...
    with tf.Graph().as_default(), tf.device("/cpu:0"):
        ...
        with tf.Session(config=config) as sess:
            ...
            checkpoint_path='models1122/zq21_cpm_train/zq21_cpm_batch-24_lr-0.001_gpus-3_224x224_experiments-zq21_cpm/'
